...
large_eyes = eye_size > 0.45
ideal_iris = (math.pi*iris_width/2*iris_height/2) / eye_size >= 0.69
ideal_eye_size = eye_height/eye_width >= 0.59
...
if large_eyes and ideal_iris and ideal_eye_size:
    print("I’m sorry I wasn’t part of your past, can I make it up by being in your future?")
